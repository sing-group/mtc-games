...
import {AudioDiceAssets} from './dice';

export class AudioAssets {

  constructor(color, letter, number, tool, trigram, word) {
    check.assert.instance(color, AudioDiceAssets, 'color should be an instance of AudioDiceAssets');
    check.assert.instance(letter, AudioDiceAssets, 'letter should be an instance of AudioDiceAssets');
    check.assert.instance(number, AudioDiceAssets, 'number should be an instance of AudioDiceAssets');
    check.assert.instance(tool, AudioDiceAssets, 'tool should be an instance of AudioDiceAssets');
    check.assert.instance(trigram, AudioDiceAssets, 'trigram should be an instance of AudioDiceAssets');
    check.assert.instance(word, AudioDiceAssets, 'word should be an instance of AudioDiceAssets');
