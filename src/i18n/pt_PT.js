...
export const pt_PT = {
  ...
  'game.config.param.candidateShown.randomWithDuplicates': 'ALEATORIO COM DUPLICADOS',
  'game.config.param.candidateShown.randomWithoutDuplicates': 'ALEATORIO SIM DUPLICADOS',
  ...
  'game.recognitionSternberg.param.candidateShown.description': 'Tipo de visualización dos candidatos (DIRECTO, INVERSO, ALEATORIO COM DUPLICADOS ou ALEATORIO SIM DUPLCADOS).',
