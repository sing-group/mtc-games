...
import {RecognitionSternbergGame} from './RecognitionSternbergGame';
...
export class RecognitionSternbergStatus extends StandardGameStatus {

  constructor(game) {
    check.assert.instance(game, RecognitionSternbergGame);

    super(game);
  }

  _buildMainRenderer() {
    return new RecognitionSternbergMainRenderer(
      new RecognitionSternbergMainStageRenderConfiguration(),
      new RecognitionSternbergMainStageStatus(this, new RecognitionSternbergMainCallback({
