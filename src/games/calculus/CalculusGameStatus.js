...
import {CalculusGame} from './CalculusGame';
...
export class CalculusGameStatus extends StandardGameStatus {

  constructor(game) {
    check.assert.instance(game, CalculusGame);

    super(game);
  }

  _buildMainRenderer() {
    return new CalculusMainRenderer(
      new CalculusMainStageRenderConfiguration(),
      new CalculusMainStageStatus(this, new CalculusMainCallback({
