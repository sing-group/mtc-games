...
export class AssociatedPairsStatus extends StandardGameStatus {

  constructor(game) {
    check.assert.instance(game, AssociatedPairsGame);

    super(game);
  }

  _buildMainRenderer() {
    return new AssociatedPairsMainRenderer(
      new AssociatedPairsMainStageRenderConfiguration(),
      new AssociatedPairsMainStageStatus(this, new AssociatedPairsMainCallback({
