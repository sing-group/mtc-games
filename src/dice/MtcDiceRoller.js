...
const RANDOM_GENERATOR = Symbol();

export class MtcDiceRoller {
  static get RANDOM_GENERATOR() {
    if (!MtcDiceRoller[RANDOM_GENERATOR]) {
      MtcDiceRoller[RANDOM_GENERATOR] = uheprng.create();
    }
