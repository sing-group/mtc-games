...
export default class RecognitionGameMainRenderer extends StageRenderer {
    ...
    create() {
        ...
        this.timeFrameSprite.x = RecognitionDesign.PIXEL_OFFSETS.FRAME_X_OFFSET;
        this.timeFrameSprite.y = this.timeFrameSprite.height / 2 + RecognitionDesign.PIXEL_OFFSETS.FRAME_Y_OFFSET;

        // Add score frame image
        this.scoreFrameSprite = this.game.add.sprite(0, 0, 'frame');
        this.scoreFrameSprite.anchor.setTo(1, 0.5);
        this.scoreFrameSprite.x = this.game.world.width - RecognitionDesign.PIXEL_OFFSETS.FRAME_X_OFFSET;
        this.scoreFrameSprite.y = this.scoreFrameSprite.height / 2 + RecognitionDesign.PIXEL_OFFSETS.FRAME_Y_OFFSET;

        // Add time text
        this.timeText = this.game.add.text(0, 0,
            this.game.i18n.text("game.standard.time") + ": " + this.game.configuration.time,
            RecognitionDesign.TEXT_STYLES.IN_GAME_TIME
        );
        ...
        this.scoreText = this.game.add.text(0, 0,
            "0 / 0",
            RecognitionDesign.TEXT_STYLES.SCORE
        );
    ...
    updateScore() {
        ...
        this.scoreText.addColor(RecognitionDesign.COLORS.SCORE_GUESSED, 0);
        this.scoreText.addColor(RecognitionDesign.COLORS.SCORE_SEPARATOR, this.scoreText.text.indexOf("/"));
        this.scoreText.addColor(RecognitionDesign.COLORS.SCORE_FAILED, this.scoreText.text.indexOf("/") + 1);
    }
