...
export default class RecognitionGameMainRenderer extends StageRenderer {
    ...
    updateScore() {
        ...
        this.game.scoreText.addColor(RecognitionDesign.COLORS.SCORE_GUESSED, 0);
        this.game.scoreText.addColor(RecognitionDesign.COLORS.SCORE_SEPARATOR, this.game.scoreText.text.indexOf("/"));
        this.game.scoreText.addColor(RecognitionDesign.COLORS.SCORE_FAILED, this.game.scoreText.text.indexOf("/") + 1);
    }
