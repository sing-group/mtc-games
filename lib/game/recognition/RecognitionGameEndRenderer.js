...
export default class RecognitionGameEndRenderer extends GameState {
    ...
    create() {
        ...
        this.game.gameDescriptionText = this.game.add.text(
            ...
            this.game.i18n.text(I18NId.forGame("recognition").result("gameCompleted").name()) + ": " + (this.game.endInfo.gameCompleted ? this.game.i18n.text("yes") : this.game.i18n.text("no")) + "\n" +
            this.game.i18n.text(I18NId.forGame("recognition").result("totalTries").name()) + ": " + this.game.endInfo.totalTries + "\n" +
            this.game.i18n.text(I18NId.forGame("recognition").result("guessedStimulus").name()) + ": " + this.game.endInfo.guessed + "\n" +
            this.game.i18n.text(I18NId.forGame("recognition").result("failedStimulus").name()) + ": " + this.game.endInfo.failed,
            style
        );
        this.game.gameDescriptionText.anchor.setTo(0.5, 0.5);
