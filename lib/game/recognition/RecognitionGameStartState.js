...
export default class RecognitionGameStartState extends GameState {
    ...
    create() {
        ...
        this.game.gameDescriptionText = this.game.add.text(
            ...
            this.game.i18n.text("game.recognition.param.timePerElement.name") + ": " + this.game.gameConfig.timePerElement + "\n" +
            this.game.i18n.text("game.recognition.param.numberOfElements.name") + ": " + this.game.gameConfig.numberOfElements,
            style
        );
        this.game.gameDescriptionText.anchor.setTo(0.5, 0.5);
