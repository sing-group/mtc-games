...
import RecognitionGameMainState from './RecognitionGameMainState.js';


export default class RecognitionGameStartState extends GameState {
    ...
    preload() {
        ...
        this.game.load.spritesheet("tutorial-button", "assets/img/tutorial-button-spritesheet.png", 300, 60);
    ...
    create() {
        ...
        this.game.gameDescriptionText = this.game.add.text(
            ...
            this.game.i18N.text("game.recognition.param.diceShowTime.name") + ": " + this.game.gameConfig.timePerElement + "\n" + 
            this.game.i18N.text("game.recognition.param.numOfStimuli.name") + ": " + this.game.gameConfig.numberOfElements,
            style
        );
        this.game.gameDescriptionText.anchor.setTo(0.5, 0.5);
    ...
    onStartGame() {
        this.game.gameMode = Game.GAME_MODES.NORMAL;
        this.game.try++;
        this.game.state.start("MainState", true, true);
    }
