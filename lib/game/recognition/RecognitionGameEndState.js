...
export default class RecognitionGameEndState extends GameState {
    ...
    preload() {
        this.game.load.spritesheet("end-tutorial-button", "assets/img/end-tutorial-button-spritesheet.png", 300, 60);
        this.game.load.spritesheet("retry-game-button", "assets/img/retry-game-button-spritesheet.png", 300, 60);
    }
