...
export default class GameConfig {
  ...
  static get DEFAULTS() {
    if (!GameConfig[DEFAULTS]) {
      GameConfig[DEFAULTS] = {
        ...
        LOCALE: 'en_US',
        DICE_SCALE: 0.40,
        DICE_SCALE_DRAGGED: 0.50,
        DICE_SCALE_SHOWN: 0.65
      };
  ...
  constructor(
    ...
    diceScale = GameConfig.DEFAULTS.DICE_SCALE,
    diceScaleDragged = GameConfig.DEFAULTS.DICE_SCALE_DRAGGED,
    diceScaleShown = GameConfig.DEFAULTS.DICE_SCALE_SHOWN
  ) {
    check.assert.instance(metadata, GameMetadata, 'metadata should be an instance of a GameMetadata subclass');
