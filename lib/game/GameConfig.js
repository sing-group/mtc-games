...
export default class GameConfig {
  ...
  static get DEFAULTS() {
    return {
      ...
      REXY: 600,
      DOMID: 'game',
      GAMESTARTCALLBACKFUNCTION: null,
      GAMEENDCALLBACKFUNCTION: null,
      LOCALE: 'en_US'
    };
  }
  ...
  constructor(
    ...
    this._resY = resY;
    this._domId = domId;
    this._gameStartCallbackFunction = gameStartCallbackFunction;
    this._gameEndCallbackFunction = gameEndCallbackFunction;
    this._locale = locale;
    this._I18N = new I18NStatic(locale = locale);
  }

  get gameStartCallbackFunction(){
    return this._gameStartCallbackFunction;
  }

  set gameStartCallbackFunction(gameStartCallbackFunction){
    this._gameStartCallbackFunction = gameStartCallbackFunction;
  }

  get gameEndCallbackFunction(){
    return this._gameEndCallbackFunction;
  }

  set gameEndCallbackFunction(gameEndCallbackFunction){
    this._gameEndCallbackFunction = gameEndCallbackFunction;
  }
