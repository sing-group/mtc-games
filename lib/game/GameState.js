...
import toolHammer from '../assets/image/dice/tool/hammer.jpg';
...
import toolSaw from '../assets/image/dice/tool/saw.jpg';
...
export default class GameState extends Phaser.State {
    ...
    preload_load_images() {
        ...
        this.game.load.image("tool-hammer", toolHammer);
        ...
        this.game.load.image("tool-saw", toolSaw);
