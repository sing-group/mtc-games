...
export default class VerbalFluencyMainRenderer extends GameRenderer {
    ...
    isLetterColliding(x, y) {
        ...
        let tempSprite = this.game.add.sprite(0, 0, "letter-" + MtcDiceFace.LETTERS_FACE_VALUES[0].toLowerCase());
        ...
        this.letterSprites.forEach(function (element) {
            if (this.getDistance(x, y, element.finalX, element.finalY) < minimumSeparation) {
                toRet = true;
            }
        }, this);
        return toRet;
