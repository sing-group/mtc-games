...
// Words defined using the LibreOffice dictionaries (https://github.com/LibreOffice/dictionaries)
export default class VerbalFluencyDictionary {
  static get en_US() {
    return [
      'ab', 'abide', 'able', 'ac', 'ace', 'ache', 'acid', 'ad', 'adj', 'afield',
      'age', 'agile', 'ah', 'aid', 'aide', 'ail', 'alb', 'ale', 'alike', 'back',
      'backfield', 'bad', 'bade', 'badge', 'bag', 'bagel', 'bah', 'bail',
      'bake', 'baked', 'bald', 'bale', 'balk', 'be', 'beach', 'bead', 'beak',
      'beck', 'bed', 'beg', 'behalf', 'belch', 'bhaji', 'bi', 'bid', 'bide',
      'big', 'bighead', 'bike', 'bile', 'bilge', 'bilk', 'black', 'blade',
      'blag', 'blah', 'bleach', 'bleak', 'ca', 'cab', 'cable', 'cad', 'cadge',
      'cafe', 'cage', 'cake', 'cal', 'calf', 'calk', 'chad', 'chafe', 'chalk',
      'chef', 'chge', 'chi', 'chide', 'chief', 'child', 'clad', 'clef', 'dab',
      'dace', 'dag', 'dale', 'deaf', 'deal', 'deb', 'decaf', 'decal', 'deck',
      'def', 'deg', 'deli', 'dial', 'dice', 'dick', 'die', 'dig', 'dike', 'ea',
      'each', 'ed', 'egad', 'eh', 'elf', 'elk', 'fa', 'fab', 'fable', 'face',
      'facile', 'fad', 'fade', 'fag', 'fail', 'fake', 'fecal', 'fed', 'fib',
      'fiche', 'fickle', 'fie', 'field', 'fig', 'filch', 'file', 'flab',
      'flack', 'flag', 'flak', 'flake', 'flea', 'fleck', 'flick', 'gab',
      'gable', 'gad', 'gal', 'gale', 'gel', 'geld', 'gelid', 'gibe', 'gild',
      'glace', 'glad', 'glade', 'glib', 'glide', 'ha', 'hack', 'hackle', 'had',
      'hag', 'hail', 'haj', 'hake', 'hale', 'half', 'he', 'head', 'heal',
      'heck', 'held', 'hi', 'hick', 'hid', 'hide', 'hie', 'hijab', 'hijack',
      'hike', 'ice', 'id', 'idea', 'ideal', 'idle', 'if', 'ilea', 'ilk', 'jab',
      'jack', 'jade', 'jag', 'jail', 'jib', 'jibe', 'jig', 'jihad', 'kale',
      'keg', 'kid', 'la', 'lab', 'lac', 'lace', 'lack', 'lad', 'lade', 'lag',
      'laid', 'lake', 'lea', 'leach', 'lead', 'leaf', 'leak', 'lech', 'leg',
      'lei', 'lib', 'lice', 'lick', 'lid', 'lie', 'lied', 'lief', 'life', 'like'
    ];
  }
