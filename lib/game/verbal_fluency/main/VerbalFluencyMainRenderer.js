...
export default class VerbalFluencyMainRenderer extends StageRenderer {
    ...
    create() {
        ...
        // Add check button
        this.game.checkButton = this.game.add.button(
            this.game.dockSprite.x + VerbalFluencyDesign.PIXEL_OFFSETS.CHECK_BUTTON_H_OFFSET,
            this.game.dockSprite.y + VerbalFluencyDesign.PIXEL_OFFSETS.CHECK_BUTTON_V_OFFSET,
            'check-button',
            this.onWordCheck,
            this,
            2,
        ...
        // Add reset button
        this.game.resetButton = this.game.add.button(
            this.game.dockSprite.x + VerbalFluencyDesign.PIXEL_OFFSETS.RESET_BUTTON_H_OFFSET,
            this.game.dockSprite.y + VerbalFluencyDesign.PIXEL_OFFSETS.RESET_BUTTON_V_OFFSET,
            'reset-button',
            this.onWordReset,
            this,
            2,
    ...
    updateScore() {
        ...
        this.game.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_SUCCESS, 0);
        this.game.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_SEPARATOR, this.game.scoreText.text.indexOf("/"));
        this.game.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_INTRUSION, this.game.scoreText.text.indexOf("/") + 1);
    }
