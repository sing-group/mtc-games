...
export default class VerbalFluencyMainRenderer extends StageRenderer {
    ...
    create() {
        ...
        this.timeFrameSprite = this.game.add.sprite(0, 0, 'time-frame');
        this.timeFrameSprite.anchor.setTo(0, 0.5);
        this.timeFrameSprite.x = 0;
        this.timeFrameSprite.y = this.timeFrameSprite.height / 2;

        // Add score frame image
        this.scoreFrameSprite = this.game.add.sprite(0, 0, 'score-frame');
        this.scoreFrameSprite.anchor.setTo(1, 0.5);
        this.scoreFrameSprite.x = this.worldWidth;
        this.scoreFrameSprite.y = this.scoreFrameSprite.height / 2;
