...
export default class VerbalFluencyMainRenderer extends StageRenderer {
    ...
    updateScore() {
        this.scoreText.text = String(this.status.countGuessedWords()) + " / " + String(this.status.countFailedWords());
        ...
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_INTRUSION, this.scoreText.text.indexOf("/") + 1);
    }
