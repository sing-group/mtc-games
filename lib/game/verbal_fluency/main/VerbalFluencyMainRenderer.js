...
export default class VerbalFluencyMainRenderer extends StageRenderer {
    ...
    create() {
        ...
        this.timeFrameSprite.x = VerbalFluencyDesign.PIXEL_OFFSETS.FRAME_X_OFFSET;
        this.timeFrameSprite.y = this.timeFrameSprite.height / 2 + VerbalFluencyDesign.PIXEL_OFFSETS.FRAME_Y_OFFSET;

        // Add score frame image
        this.scoreFrameSprite = this.game.add.sprite(0, 0, 'frame');
        this.scoreFrameSprite.anchor.setTo(1, 0.5);
        this.scoreFrameSprite.x = this.worldWidth - VerbalFluencyDesign.PIXEL_OFFSETS.FRAME_X_OFFSET;
        this.scoreFrameSprite.y = this.scoreFrameSprite.height / 2 + VerbalFluencyDesign.PIXEL_OFFSETS.FRAME_Y_OFFSET;

        // Add time text
        this.timeText = this.game.add.text(0, 0,
            this.getStandardGameText('time') + ': ' + this.game.configuration.time,
            VerbalFluencyDesign.TEXT_STYLES.IN_GAME_TIME
        );
        ...
        this.scoreText = this.game.add.text(0, 0,
            '0 / 0',
            VerbalFluencyDesign.TEXT_STYLES.SCORE
        );
        ...
        this.checkButton = this.game.add.button(
            this.dockSprite.x + VerbalFluencyDesign.PIXEL_OFFSETS.CHECK_BUTTON_H_OFFSET,
            this.dockSprite.y + VerbalFluencyDesign.PIXEL_OFFSETS.CHECK_BUTTON_V_OFFSET,
            'check-button',
            this.onWordCheck,
            this,
            2,
        ...
        this.resetButton = this.game.add.button(
            this.dockSprite.x + VerbalFluencyDesign.PIXEL_OFFSETS.RESET_BUTTON_H_OFFSET,
            this.dockSprite.y + VerbalFluencyDesign.PIXEL_OFFSETS.RESET_BUTTON_V_OFFSET,
            'reset-button',
            this.onWordReset,
            this,
            2,
    ...
    updateScore() {
        ...
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_SUCCESS, 0);
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_SEPARATOR, this.scoreText.text.indexOf('/'));
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_REPETITION, this.scoreText.text.indexOf('/') + 1);
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_SEPARATOR, this.scoreText.text.lastIndexOf('/'));
        this.scoreText.addColor(VerbalFluencyDesign.COLORS.SCORE_INTRUSION, this.scoreText.text.lastIndexOf('/') + 1);
    }
