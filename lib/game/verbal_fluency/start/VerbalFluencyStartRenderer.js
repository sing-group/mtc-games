...
export default class VerbalFluencyStartRenderer extends StageRenderer {
    ...
    create() {
        // Background color
        this.game.stage.backgroundColor = VerbalFluencyDesign.COLORS.START_BACKGROUND;
        ...
        this.gameDescriptionText = this.game.add.text(
            ...
            VerbalFluencyDesign.TEXT_STYLES.DESCRIPTION
        );
        this.gameDescriptionText.anchor.setTo(0.5, 0.5);
