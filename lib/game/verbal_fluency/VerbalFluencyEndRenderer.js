...
export default class VerbalFluencyEndRenderer extends GameState {
    ...
    create() {
        ...
        this.game.gameDescriptionText = this.game.add.text(
            ...
            this.game.i18n.text(I18NId.forGame("verbalFluency").result("attempts").name()) + ": " + this.game.endInfo.totalAttempts + "\n" +
            this.game.i18n.text(I18NId.forGame("verbalFluency").result("guessedWords").name()) + ": " + this.game.endInfo.totalGuessedWords + "\n" +
            this.game.i18n.text(I18NId.forGame("verbalFluency").result("failedWords").name()) + ": " + (this.game.endInfo.totalAttempts - this.game.endInfo.totalGuessedWords) + "\n" +
            this.game.i18n.text(I18NId.forGame("verbalFluency").result("repeatedWords").name()) + ": " + this.game.endInfo.repeatedGuesses,
            style
        );
        this.game.gameDescriptionText.anchor.setTo(0.5, 0.5);
