...
import IntegerParameter from './parameter/basic/IntegerParameter';
...
export default class StandardGameMetadata extends GameMetadata {
  ...
  constructor(
    ...
    defaultNumberOfRetries = StandardGameMetadata.DEFAULTS.NUMBER_OF_RETRIES
  ) {
    super(
      id,
      taskTypes,
      [
        ...
        Parameter.build(IntegerParameter, 'standard', 'numberOfTries', defaultNumberOfRetries, 1, 5),
        ...parameters
      ],
      gameCallbackType,
      nameId,
